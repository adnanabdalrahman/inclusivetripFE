...
<div class="flex flex-col items-start p-16 gap-12 rounded-t-lg">
...
<div className="flex flex-col items-start gap-2 w-[487px] h-[70px]">
        ...
        <input className="flex items-center px-4 py-3 w-[487px] min-w-[240px] h-[40px] bg-white border border-[#D9D9D9] rounded-lg" type="text" type="text" value={"Mustermann"} onChange={(e) => setUserlastname(e.target.value)} placeholder="Nachname" />
        </div>
        ...
        <div class="flex-1 p-0 ml-16  mt-0">
